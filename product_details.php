	...
	<div class="row">	  
			...
			<div class="span6">
               <?php
					...
					if(!isset($_SESSION["userid"]) || $sellerID!=$selid){				
					echo "<h3>".$ad_t."</h3>";
					 echo "<hr class='soft'/>";
					if($cat==1){
						 echo " <p>Title : ".$tite."</p>";
				...
				{	echo "<form method='post' action='updatead.php' id=form1>";
					echo "<input type='text' style='display:none' name='adid' value='".$ad."'>";
					echo "<table style='border:0px'>";
					echo"<tr><td colspan=2><input type='text' disabled='disabled' id='adt' name='ad_t' value='".$ad_t."'></td>";
					echo "<td><input name='c_adt' type='checkbox' id='c_adt' value='y' onClick='form1.adt.disabled =!this.checked;' /></td></tr>";

					if($cat==1){
						echo"<tr><td>title</td>";
					echo"<td><input type='text' disabled='disabled' id='ttl' value='".$tite."' name='tite'></td>";
					...
					echo"<td><input type='text' disabled='disabled' id='ath' value='".$author."',name='author'></td>";
					...
					echo"<td><input type='text' disabled='disabled' id='pub' value='".$publisher."' name='publisher'></td>";
					...
					echo"<td><input type='text' disabled='disabled' id='brn' value='".$branch."' name='branch'></td>";
					echo "<td><input name='c_brn' type='checkbox' id='c_brn' value='y' onClick='form1.brn.disabled =!this.checked;' /></td></tr>";

					}
					else{
					echo"<tr><td>Brand</td>";
					echo"<td><input type='text' disabled='disabled' id='brnd' value='".$brand."' name='brand'></td>";
					echo "<td><input name='c_brnd' type='checkbox' id='c_brnd' value='y' onClick='form1.brnd.disabled =!this.checked;' /></td></tr>";
						}
					echo"<tr><td>Price</td>";
					echo"<td><input type='text' disabled='disabled' id='prc' value='".$price."' name='price'></td>";
					...
					echo"<td><input type='text' disabled='disabled' id='tu' value='".$time."' name='time'></td>";
					...
					echo"<td ><textarea  value='".$des."' rows='3' disabled='disabled' id='desc' name='desc' >".$des." </textarea></td>";
					echo "<td><input name='c_desc' type='checkbox' id='c_desc' value='y' onClick='form1.desc.disabled =!this.checked;' /></td></tr>";
					
					echo "<tr><td>Status</td>";
					echo "<td colspan=2><select name='stat' id='stat'><option>available</option><option>sold</option></select></td></tr>";
					echo"<tr><td colspan=3><center><input type='submit' value='update'></center></td><tr>";
					echo"</form></table>";
            ...
            <div id="myTabContent" class="tab-content">
              ...
              <?php
			  $query="SELECT * from user,ad where user.uid=ad.s_id and ad_id='$ad' and status='available'";
			  $result=mysql_query($query);
				$row=mysql_fetch_array($result);
				$fname=$row['f_name'];
					$lname=$row['l_name'];
